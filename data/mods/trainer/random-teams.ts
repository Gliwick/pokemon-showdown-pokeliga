...
const SEASONAL_TRAINERS: Record<Tier | '*', string[]> = {
	'*': [
		...
		'Rei/Akari', 'Geeta',
		// Rapid Spin
		'Spenser', 'Tierno', 'Sada', 'Turo', 'Arven', 'Marnie', 'Maiko',
		// Defog
		'Blue', 'Darach and Caitlin', 'Cyrus', 'Essentia', 'Nate', 'Terrel',
		// Magic Bounce
		'Dexio', 'Sabrina', 'Lucas', 'Mars',
		// Contrary
		'Mallow', 'Plumeria', 'Raifort', 'Cyrano', 'Aliana/Bryony/Celosia/Mable',
	],
	'Uber': [
		// Stealth Rock
		'Florian/Juliana',
...
const SEASONAL_POKEMON: Record<string, string[]> = {
	...
	'Raihan': ['Gigalith'],
	'Inver': ['Rhyperior'],
	'Alain': ['Tyranitar', 'Malamar'],
	'Dawn': ['Wormadam-Trash'],
	'Barry': ['Torterra'],
	'Hilbert/Hilda/Nate/Rosa': ['Gigalith'],
	'Sashay': ['Forretress', 'Blissey'],
	'Kamado': ['Probopass'],
	'Zisu': ['Steelix'],
	'Goh': ['Cursola'],
...
export class RandomMTTeams extends RandomTeams {
	...
	getMTLevel(formatData: MTFormatData, species: Species, moves: string[], abilityName: string, itemName: string, tier: Tier) {
		...
		if (['Pidgeot', 'Primeape', 'Swellow'].includes(species.name)) {
			speciesLevel = 88;
		}
