...
export const Formats: FormatList = [
	...
	},
	{
		...
		banlist: [
			'CAP',
			// cosmetic
			'Pikachu-Cosplay', 'Pichu-Spiky-eared', 'Xerneas-Base',
			// pokestar
			'Pokestar Smeargle', 'Pokestar UFO', 'Pokestar UFO-2', 'Pokestar Brycen-Man', 'Pokestar MT', 'Pokestar MT2', 'Pokestar Transport', 'Pokestar Giant', 'Pokestar Humanoid', 'Pokestar Monster', 'Pokestar F-00', 'Pokestar F-002', 'Pokestar Spirit', 'Pokestar Black Door', 'Pokestar White Door', 'Pokestar Black Belt', 'Pokestar UFO-PropU2',
			// useless abilities
			'No Ability', 'Ball Fetch', 'Battle Bond', 'Commander', 'Disguise', 'Embody Aspect (Cornerstone)', 'Embody Aspect (Hearthflame)',
			'Embody Aspect (Teal)', 'Embody Aspect (Wellspring)', 'Flower Gift', 'Forecast', 'Gulp Missile', 'Honey Gather', 'Hunger Switch',
			'Ice Face', 'Multitype', 'Power Construct', 'RKS System', 'Run Away', 'Schooling', 'Shields Down', 'Stance Change', 'Zen Mode', 'Zero to Hero',
			// useless abilities in singles
			'Battery', 'Costar', 'Curious Medicine', 'Friend Guard', 'Healer', 'Hospitality', 'Minus', 'Plus', 'Power of Alchemy', 'Power Spot',
			'Propeller Tail', 'Receiver', 'Stalwart', 'Symbiosis', 'Telepathy',
			// useless moves
			'Celebrate', 'Dark Void', 'Happy Hour', 'Hold Hands', 'Hyperspace Fury', 'Splash',
			// useless moves in singles
			'After You', 'Ally Switch', 'Aromatic Mist', 'Coaching', 'Floral Healing', 'Follow Me', 'Heal Pulse', 'Helping Hand',
			'Quash', 'Quick Guard', 'Rage Powder', 'Spotlight', 'Wide Guard',
			// useless items
			'Deep Sea Scale', 'Deep Sea Tooth', 'Metal Powder', 'Quick Powder', 'Thick Club',
		],
		unbanlist: ['All Pokemon', 'All Abilities', 'All Items'],
	},
	{
		...
		banlist: [
			...
			'Celebrate', 'Dark Void', 'Happy Hour', 'Hold Hands', 'Hyperspace Fury', 'Splash',
			// useless items
			'Deep Sea Scale', 'Deep Sea Tooth', 'Light Ball', 'Metal Powder', 'Quick Powder', 'Thick Club',
		],
		unbanlist: ['All Pokemon', 'All Abilities', 'All Items', 'LGPE'],
	},
	{
		...
		unbanlist: [
			// pokemon
			'Absol-Mega', 'Aerodactyl-Mega', 'Aggron', 'Aggron-Mega', 'Alakazam-Mega', 'Ampharos-Mega', 'Arceus', 'Archeops',
			'Beedrill-Mega', 'Blacephalon', 'Blastoise-Mega', 'Blaziken-Mega', 'Blissey', 'Buzzwole', 'Calyrex-Ice', 'Calyrex-Shadow',
			'Charizard-Mega-X', 'Charizard-Mega-Y', 'Chien-Pao', 'Chi-Yu', 'Darkrai', 'Darmanitan-Galar-Zen', 'Deoxys-Attack',
			'Deoxys-Defense', 'Deoxys-Speed', 'Dialga', 'Dialga-Origin', 'Diancie-Mega', 'Dondozo', 'Dragapult', 'Electrode-Hisui',
			'Eternatus', 'Eternatus-Eternamax', 'Flutter Mane', 'Gallade-Mega', 'Garchomp-Mega', 'Gardevoir-Mega', 'Gengar-Mega',
			'Giratina', 'Giratina-Origin', 'Glastrier', 'Goodra', 'Greninja-Ash', 'Groudon', 'Groudon-Primal', 'Gyarados-Mega',
			'Heracross-Mega', 'Houndoom-Mega', 'Ho-Oh', 'Hoopa-Unbound', 'Iron Bundle', 'Iron Hands', 'Iron Moth', 'Kartana', 'Koraidon',
			'Kyogre-Primal', 'Kyurem-Black', 'Kyurem-White', 'Landorus-Therian', 'Latias-Mega', 'Latios-Mega', 'Lucario-Mega', 'Lugia',
			'Lunala', 'Melmetal', 'Metagross-Mega', 'Mewtwo-Mega-X', 'Mewtwo-Mega-Y', 'Miraidon', 'Necrozma-Dawn-Wings',
			'Necrozma-Dusk-Mane', 'Necrozma-Ultra', 'Ogerpon-Base', 'Ogerpon-Hearthflame', 'Palafin-Hero', 'Palkia', 'Palkia-Origin',
			'Pheromosa', 'Raging Bolt', 'Rayquaza-Mega', 'Regieleki', 'Regigigas', 'Regirock', 'Reshiram', 'Roaring Moon', 'Salamence-Mega',
			'Sceptile-Mega', 'Sharpedo-Mega', 'Slaking', 'Slither Wing', 'Slowbro-Mega', 'Snorlax', 'Solgaleo', 'Spectrier', 'Stakataka',
			'Steelix-Mega', 'Swampert-Mega', 'Tapu Koko', 'Terapagos-Stellar', 'Thundurus-Therian', 'Ting-Lu', 'Toxapex',
			'Tyranitar-Mega', 'Ursaluna', 'Ursaluna-Bloodmoon', 'Venusaur-Mega', 'Xerneas', 'Xurkitree', 'Yveltal', 'Zacian',
			'Zacian-Crowned', 'Zamazenta', 'Zamazenta-Crowned', 'Zekrom', 'Zeraora', 'Zygarde-Complete',
			// abilities
			'Anger Shell', 'Arena Trap', 'As One (Glastrier)', 'As One (Spectrier)', 'Beads of Ruin', 'Berserk', 'Comatose',
			'Chilling Neigh', 'Download', 'Fluffy', 'Fur Coat', 'Grassy Surge', 'Grim Neigh', 'Hadron Engine', 'Huge Power', 'Ice Scales', 'Illusion',
			'Imposter', 'Infiltrator', 'Innards Out', 'Levitate', 'Libero', 'Magic Bounce', 'Magic Guard', 'Mold Breaker', 'Moody', 'Moxie',
			'Misty Surge', 'Neutralizing Gas', 'Opportunist', 'Orichalcum Pulse', 'Parental Bond', 'Protean', 'Pure Power',
			'Purifying Salt', 'Psychic Surge', 'Quick Draw', 'Regenerator', 'Screen Cleaner', 'Shadow Shield', 'Shadow Tag', 'Simple',
			'Sheer Force', 'Soul-Heart', 'Soundproof', 'Speed Boost', 'Stakeout', 'Stamina', 'Supreme Overlord', 'Technician', 'Thick Fat',
			'Tinted Lens', 'Toxic Chain', 'Toxic Debris', 'Unaware', 'Wonder Guard',
			// moves
			'10,000,000 Volt Thunderbolt', 'Anchor Shot', 'Apple Acid', 'Aqua Step', 'Astral Barrage', 'Baddy Bad', 'Baneful Bunker',
			'Baton Pass', 'Beak Blast', 'Belly Drum', 'Bitter Blade', 'Bitter Malice', 'Blue Flare', 'Body Press', 'Bolt Beak',
			'Bolt Strike', 'Boomburst', 'Burning Bulwark', 'Buzzy Buzz', 'Catastropika', 'Ceaseless Edge', 'Chatter', 'Chloroblast',
			'Clangorous Soul', 'Chilly Reception', 'Clangorous Soulblaze', 'Clear Smog', 'Circle Throw', 'Combat Torque', 'Core Enforcer',
			'Diamond Storm', 'Dire Claw', 'Doom Desire', 'Double Iron Bash', 'Dragon Energy', 'Dragon Tail', 'Drum Beating', 'Electro Shot',
			'Eruption', 'Esper Wing', 'Expanding Force', 'Explosion', 'Extreme Evoboost', 'Extreme Speed', 'Fickle Beam', 'Fillet Away',
			'Fire Lash', 'First Impression', 'Fishious Rend', 'Flip Turn', 'Focus Blast', 'Foul Play', 'Freezy Frost', 'Genesis Supernova',
			'Geomancy', 'Gigaton Hammer', 'Glacial Lance', 'Glitzy Glow', 'G-Max Cannonade', 'G-Max Resonance', 'G-Max Steelsurge',
			'G-Max Vine Lash', 'G-Max Volcalith', 'G-Max Wildfire', 'Grav Apple', 'Guardian of Alola', 'Gunk Shot', 'Head Smash',
			'Heal Order', 'Hydro Steam', 'Jet Punch', 'Jungle Healing', 'Knock Off', 'Last Respects', 'Leech Life', 'Leech Seed',
			"Let's Snuggle Forever", 'Light That Burns the Sky', 'Light of Ruin', 'Lovely Kiss', 'Lumina Crash', 'Lunar Blessing', 'Lunge',
			'Luster Purge', 'Lunar Dance', 'Magma Storm', 'Malicious Moonsault', 'Malignant Chain', 'Matcha Gotcha', 'Megahorn',
			'Menacing Moonraze Maelstrom', 'Meteor Beam', 'Mind Blown', 'Minimize', 'Moongeist Beam', 'Moonlight', 'Morning Sun',
			'Mortal Spin', 'Mystical Power', 'Night Daze', 'No Retreat', 'Oblivion Wing', 'Oceanic Operetta', 'Octolock', 'Power Trip',
			'Photon Geyser', 'Population Bomb', 'Psyblade', 'Psychic Fangs', 'Psychic Noise', 'Parting Shot', 'Power Whip',
			'Precipice Blades', 'Psyshield Bash', 'Psystrike', 'Pulverizing Pancake', 'Pursuit', 'Pyro Ball', 'Quiver Dance', 'Rage Fist',
			'Raging Bull', 'Rapid Spin', 'Revival Blessing', 'Rising Voltage', 'Sacred Fire', 'Salt Cure', 'Sappy Seed', 'Scorching Sands',
			'Searing Shot', 'Searing Sunraze Smash', 'Secret Sword', 'Seed Flare', 'Shed Tail', 'Shell Side Arm', 'Shell Smash',
			'Shift Gear', 'Sinister Arrow Raid', 'Soul-Stealing 7-Star Strike', 'Sparkly Swirl', 'Spectral Thief', 'Spiky Shield',
			'Spirit Break', 'Spirit Shackle', 'Splintered Stormshards', 'Spore', 'Steam Eruption', 'Steel Beam', 'Stone Axe', 'Sticky Web',
			'Stoked Sparksurfer', 'Stored Power', 'Strength Sap', 'Sucker Punch', 'Surging Strikes', 'Sunsteel Strike', 'Synthesis',
			'Syrup Bomb', 'Tail Glow', 'Take Heart', 'Thunderous Kick', 'Thousand Arrows', 'Thousand Waves', 'Thunder Cage', 'Thunderclap',
			'Tidy Up', 'Topsy-Turvy', 'Torch Song', 'Toxic', 'Triple Arrows', 'Triple Axel', 'U-turn', 'V-create', 'Victory Dance',
			'Volt Switch', 'Water Shuriken', 'Water Spout', 'Will-O-Wisp', 'Wish', 'Zippy Zap',
			// items
			'Ability Shield', 'Berserk Gene', 'Blunder Policy', 'Chilan Berry', 'Choice Scarf', 'Covert Cloak', 'Expert Belt', 'Focus Band',
			'Focus Sash', 'Heavy-Duty Boots', "King's Rock", 'Leppa Berry', 'Leftovers', 'Life Orb', 'Lum Berry', 'item: Metronome',
			'Mirror Herb', 'Quick Claw', 'Razor Claw', 'Razor Fang', 'Rocky Helmet', 'Salac Berry', 'Scope Lens', 'Sitrus Berry', 'Weakness Policy',
		],
	},
	{
	...
	*/{
	...
	{
		section: "Pokeliga Other Metagames",
		column: 2,
	},
	{
		name: "[Gen 9] Superability",

		mod: 'superability',
		ruleset: ['Standard'],
		banlist: [
			// OU bans
			'Uber', 'AG', 'Arena Trap', 'Moody', 'Sand Veil', 'Shadow Tag', 'Snow Cloak', 'King\'s Rock', 'Razor Fang', 'Baton Pass', 'Last Respects', 'Shed Tail',
			// Superability
			'Azumarill', 'Medicham',
			// Serene Grace
			'Serene Grace + Air Slash', 'Serene Grace + Astonish', 'Serene Grace + Bite', 'Serene Grace + Dark Pulse', 'Serene Grace + Dragon Rush', 'Serene Grace + Extrasensory', 'Serene Grace + Fiery Wrath', 'Serene Grace + Fire Fang', 'Serene Grace + Headbutt', 'Serene Grace + Ice Fang', 'Serene Grace + Icicle Crash', 'Serene Grace + Iron Head', 'Serene Grace + Mountain Gale', 'Serene Grace + Rock Slide', 'Serene Grace + Sky Attack', 'Serene Grace + Snore', 'Serene Grace + Stomp', 'Serene Grace + Thunder Fang', 'Serene Grace + Triple Arrows', 'Serene Grace + Twister', 'Serene Grace + Waterfall', 'Serene Grace + Zen Headbutt', 'Serene Grace + Zing Zap',
		],
	},
	{
		section: "Pokeliga Randomized Metas",
		column: 2,
	},
	{
		name: "[Gen 9] Masters Tournament Random Battle",

		mod: 'trainer',
		team: 'randomMT',
		ruleset: ['Team Preview', 'Obtainable', 'Species Clause', 'HP Percentage Mod', 'Cancel Mod'],

		onBegin() {
			const sideIds: { [key: string]: boolean } = {};
			for (const pokemon of this.getAllPokemon()) {
				if (!(pokemon.side.id in sideIds)) {
					sideIds[pokemon.side.id] = true;
					this.add('html', `${pokemon.side.name} is using ${pokemon.set.trainerName}'s team!`);
					this.add('html', `<img src="${pokemon.set.trainerSprite}" style="max-height: 120px;" />`);
				}
			}
		},
		onSwitchIn(pokemon) {
			const aura = (pokemon.set as any).aura as SparseBoostsTable | undefined;
			if (aura) {
				this.add('-message', pokemon.name + "'s Aura flared to life!");
				this.boost(aura, pokemon);
			}

			if (pokemon.set.status) {
				pokemon.addVolatile(pokemon.set.status as string);
			}

			const pokemon2 = pokemon.illusion || pokemon;
			let possibleSpeed = pokemon2.set.possibleSpeed as number[] | undefined;
			if (!possibleSpeed?.length) return;

			possibleSpeed = Array.from(new Set(possibleSpeed));
			const defaultSpe = Math.floor(Math.floor(
				2 * pokemon2.species.baseStats.spe + 31 + Math.floor(84 / 4)
			) * pokemon2.set.level / 100 + 5);
			if (possibleSpeed.length === 1 && possibleSpeed[0] === defaultSpe) return;

			this.add('-message', pokemon2.name + "'s speed: " + possibleSpeed.sort((a, b) => a - b).join('/') + ' (before items/abilities/modifiers)');
		},
	},
	{
		name: "[Gen 9] Superability Random Battle",
